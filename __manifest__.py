# -*- coding: utf-8 -*-
{
    ...
    'depends': ['ev_config_connect_api', 'ev_api_sync_base','contacts','product', 'queue_job', 'izi_lib', 'base','ev_tnu_hp_master_data', 'ev_tnu_thanh_toan_sv', 'ev_tnu_ql_dot_thu'],
    ...
    'data': [
        ...
        'views/log_sync_receive_ttsv_views.xml',
